...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('img/varios/favicon.ico')); ?>">
...
<header>
    ...
    <div class="area-logo">
        <a href="/"><img src="<?php echo e(asset('img/varios/logo-cinestar.png')); ?>"/></a>
    </div>
    <nav class="menu">
        <span class="img-social">
            <a href="http://www.facebook.com/multicinestar" target="_blank"><img src="<?php echo e(asset('img/varios/ico-face.png')); ?>"></a>
            <a href="http://www.twitter.com/multicinestar" target="_blank"><img src="<?php echo e(asset('img/varios/ico-twitter.png')); ?>"></a>
        </span>
        <span class="social">Síguenos en: </span>
        <ul class="menu-principal">
            <li class="menu-item"><a href="<?php echo e(url('/peliculas/cartelera')); ?>">Cartelera</a></li>
            <li class="menu-item"><a href="<?php echo e(url('/peliculas/estrenos')); ?>">Próximos estrenos</a></li>
            <li class="menu-item"><a href="http://www.cinestar.com.pe/starcard">Star Card</a></li>
            <li class="menu-item"><a href="<?php echo e(url('/cines')); ?>">Nuestros Cines</a></li>
    ...
    <div class="papaya">
        <a href="http://www.cinepapaya.com/pe/cinestar" target="_blank"><img src="<?php echo e(asset('img/varios/bg-papaya.jpg')); ?>"/></a>
    </div>
</header>

<div class="contenido">
    <div class="publicidad">
        <a href="http://www.cinestar.com.pe/starcard/"><img src="<?php echo e(asset('img/varios/starcard.jpg')); ?>"></a>
        <a href="http://www.cinestar.com.pe/cinefilo_star/"><img src="<?php echo e(asset('img/varios/cinefilo-star.jpg')); ?>"></a>
    </div>
    <div class="contenido-interno" id="contenido-interno">
        <div class="contenido-wrapper">
            <?php echo $__env->yieldContent('contenido_interno'); ?>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\laravel_cinestar\resources\views/index.blade.php ENDPATH**/ ?>